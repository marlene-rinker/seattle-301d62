...
function displayPics(){
  ...
  // DONE: In a sentence or two, explain why the previous line of code threw an error when we changed the constiable declaration from `const to `const`.
  // rando was locally scoped in the code block. The console.log was called after the code block. rando was deleted after the code block so it no longer existed.
  console.log(viewed);
