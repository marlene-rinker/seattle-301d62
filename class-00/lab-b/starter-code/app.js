...
// you lose contextual this with an arrow function
...
// can't use an arrow function if need to reference the student with "this"
...
Student.prototype.scopeArrow = () => console.log('scopeArrow this ', this);
...
// 'this' outside of joe.scopeArrow which is the window; 'this' pointed at joe (joe.scope)
